 ...
 */
export declare function parseBoardConfig(content: string): {
    config: BoardConfig;
    body: string;
} | null;
/**
 ...
 */
export declare function serializeBoardConfig(config: BoardConfig, body?: string): string;
//# sourceMappingURL=boardContent.d.ts.map