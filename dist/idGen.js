...
exports.extractTaskIdNumber = extractTaskIdNumber;
exports.getMaxTaskIdNumber = getMaxTaskIdNumber;
exports.generateNextTaskId = generateNextTaskId;
exports.generateSubtaskId = generateSubtaskId;
exports.generateNextSubtaskId = generateNextSubtaskId;
exports.isValidTaskId = isValidTaskId;
exports.isValidSubtaskId = isValidSubtaskId;
exports.getParentTaskId = getParentTaskId;
 ...
 */
function extractTaskIdNumber(taskId, prefix = DEFAULT_PREFIX) {
 ...
 */
function getMaxTaskIdNumber(board) {
    const allTaskIds = board.columns.flatMap((col) => col.tasks.map((t) => extractTaskIdNumber(t.id)));
 ...
 */
function generateNextTaskId(board) {
 ...
 */
function generateSubtaskId(taskId, index) {
    return `${taskId}-${index}`;
}
/**
 ...
 */
function generateNextSubtaskId(taskId, existingSubtaskIds) {
 ...
 */
function isValidTaskId(taskId, prefix = DEFAULT_PREFIX) {
    const escaped = prefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
 ...
 * @returns True if valid format
 */
function isValidSubtaskId(subtaskId, prefix = DEFAULT_PREFIX) {
    const escaped = prefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
 ...
 */
function getParentTaskId(subtaskId, prefix = DEFAULT_PREFIX) {
    const escaped = prefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
