...
exports.diffBoards = diffBoards;
/**
  * Compute a structural diff between two Board objects.
  */
function diffBoards(previous, next) {
    ...
    for (const [taskId, nextInfo] of nextTasks.entries()) {
        ...
        const moved = prevInfo.columnId !== nextInfo.columnId ||
...
function detectChangedFields(before, after, fields) {
    const changed = [];
...
//# sourceMappingURL=realtimeDiff.js.map